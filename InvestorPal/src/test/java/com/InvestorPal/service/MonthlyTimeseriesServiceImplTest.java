...
class MonthlyTimeseriesServiceImplTest {
    ...
    public void canGenerateForecast() {
        List<List<NumericPrediction>> forecastedData =
                monthlyTimeseriesService.getTimeseriesForecast("JPM",MLmodel.GAUSSIAN_PROCESS);
    ...
    public void canGenerateForecastUsingLinearRegression() {
        List<List<NumericPrediction>> forecastedData =
                monthlyTimeseriesService.getTimeseriesForecast("JPM",MLmodel.LINEAR_REGRESSION);
        System.out.println(forecastedData.toString());
        assertNotNull(forecastedData);
    }
    ...
    public void canGenerateForecastUsingKNN() {
        List<List<NumericPrediction>> forecastedData =
                monthlyTimeseriesService.getTimeseriesForecast("JPM",MLmodel.KNN);
        System.out.println(forecastedData.toString());
        assertNotNull(forecastedData);
    }
    ...
    public void canGenerateForecastUsingSVR() {
        List<List<NumericPrediction>> forecastedData =
                monthlyTimeseriesService.getTimeseriesForecast("JPM",MLmodel.SVR);
        System.out.println(forecastedData.toString());
        assertNotNull(forecastedData);
    }
    ...
    public void canGenerateForecastUsingDecisionTrees() {
        List<List<NumericPrediction>> forecastedData =
                monthlyTimeseriesService.getTimeseriesForecast("JPM",MLmodel.DECISION_TREE);
        System.out.println(forecastedData.toString());
        assertNotNull(forecastedData);
    }
    @Test
    public void canGenerateForecastUsingNeuralNetworks() {
        List<List<NumericPrediction>> forecastedData =
                monthlyTimeseriesService.getTimeseriesForecast("JPM",MLmodel.NEURAL_NETWORK);
        System.out.println(forecastedData.toString());
        assertNotNull(forecastedData);
    }
}